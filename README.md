...
* [Govee device](https://eu.govee.com) (only tested with Smart Outdoor S14 Bulb String Lights 2, H702A). Only on/off and brightness control succeeded using the LAN API. RGB and color temperature were unsuccessful
